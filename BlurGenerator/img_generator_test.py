...
def main():
    bg_test_ids = extractLabelList(COCO_ROOT)[10000:20000]
    ...
    for bg_id in bg_test_ids:
        ...
        cv2.imwrite('./coco_sharp_image_test/{}.png'.format(foldername), frames[gt_index])
        cv2.imwrite('./coco_blur_image_test/{}.png'.format(foldername), blur_frame)
        np.save('./coco_blur_mask_test/{}.npy'.format(foldername), total_blur_mask)
        '''
