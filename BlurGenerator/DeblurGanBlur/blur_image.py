...
from DeblurGanBlur.generate_PSF import PSF
from DeblurGanBlur.generate_trajectory import Trajectory
import cv2
...
class BlurImage(object):
    ...
    def __init__(self, image_path, PSFs=None, part=None, path__to_save=None):
        ...
        self.original = cv2.resize(cv2.imread(image_path), (256,256))
...
if __name__ == '__main__':
    folder = '/home/wangzerun/BlurGenerator/DeblurGanBlur/sharp/'
    folder_to_save = '/home/wangzerun/BlurGenerator/DeblurGanBlur/blur/'
